...
INSERT INTO `product` VALUES (1,'Cà phê sữa đá'),(2,'Cà phê sữa '),(3,'Cà phê sữa bò'),(4,'Cà phê sữa dê');
...
CREATE TABLE `product_order` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `summary_order` int DEFAULT NULL,
...
INSERT INTO `product_order` VALUES (1,1,4),(2,20,1),(3,12,2),(4,25,3);
...
INSERT INTO `stock` VALUES (1,25,1),(2,1,2),(3,30,3),(4,5,4);
...
INSERT INTO `users` VALUES (1,'nguyenvana@gmail.com','Nguyen Van A');
...
-- Dump completed on 2025-05-27  3:59:41
